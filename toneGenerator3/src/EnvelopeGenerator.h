...
class WavetableGeneratorContainer
{
public:
    static vector<OscillatorWavetable> oscillatorWavetables;
    static vector<FrequencyModulationWavetable> frequencyModulationWavetables;
    static vector<AmplitudeModulationWavetable> amplitudeModulationWavetables;
    static vector<RingModulationWavetable> ringModulationWavetables;
};
